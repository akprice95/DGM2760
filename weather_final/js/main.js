...
function loadWeather(){
	...
	if (zip === ''){zip = "84043";}
	var conditionsPath = "http://api.wunderground.com/api/b9a07e279322e3fb/conditions/q/"+zip+".json";
	var forecastPath = "http://api.wunderground.com/api/b9a07e279322e3fb/forecast/q/"+zip+".json";
...
// GET THE FORECARST
weatherForecast.open('GET', 'http://api.wunderground.com/api/b9a07e279322e3fb/forecast/q/84043.json', true);
weatherForecast.responseType = 'text'; 
weatherForecast.send();
